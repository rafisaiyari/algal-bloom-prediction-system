...
class Sidebar(tk.Frame):
    def __init__(self, parent, controller, icon_manager, mainFrame, user_type="regular"):
        ...
        self.btn6 = tk.Button(self, image=self.SIcon, cursor="hand2", anchor="center", bg="#1d97bd", relief="flat",
                              fg="#F1F1F1",
    ...
    def fill(self):
        ...
        if self.expanded:
            ...
            self.btn2.config(text=" DASHBOARD", image=self.DBIcon, compound="left", fg="#f1f1f1", width=20,
                             bg="#1d97bd", anchor="w", padx=10)
            self.btn3.config(text=" INPUT DATA", image=self.IPIcon, compound="left", fg="#f1f1f1", width=20,
                             bg="#1d97bd", anchor="w", padx=10)
            self.btn4.config(text=" WATER QUALITY\nREPORT", image=self.WQRIcon, compound="left", fg="#f1f1f1", width=20,
                             bg="#1d97bd", anchor="w", padx=10)
            self.btn5.config(text=" PREDICTION TOOL", image=self.PTIcon, compound="left", fg="#f1f1f1", width=20,
                             bg="#1d97bd", anchor="w", padx=10)
            self.btn6.config(text=" SETTINGS", image=self.SIcon, compound="left", fg="#f1f1f1", width=20, bg="#1d97bd",
                             anchor="w", padx=10)
        else:
