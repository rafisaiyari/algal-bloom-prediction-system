...
class dashboardPage(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.param_var_cb = {param: tk.IntVar() for param in ["pH", "Ammonia", "Nitrate", "Phosphate", "Chlorophyll-a", "Temperature", "DO"]}
        ...
        def disp_btn():
            ...
            if self.mode == "yearly":
                ...
                for i, param in enumerate(["pH", "Ammonia", "Nitrate", "Phosphate", "Chlorophyll-a", "Temperature", "DO"]):
        ...
        monthly_btn = tk.Button(self, text="Get Monthly Data", command=display_selected_data_bar, font=("Arial", 12), bg="#1d97bd", fg="white")
        monthly_btn.grid(row=5, column=0, padx=10, pady=5, sticky="w")
        
        yearly_btn = tk.Button(self, text=" Get Yearly Data", command=display_selected_data_line, font=("Arial", 12), bg="#1d97bd", fg="white")
