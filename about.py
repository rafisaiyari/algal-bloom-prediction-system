...
class AboutPage(tk.Frame):
    ...
    def create_widgets(self):
        aboutlb = tk.Label(self, text="ABOUT US: THE DEVELOPERS", justify="left", anchor="w",
                           font=("Arial", 25, "bold"))
        ...
        self.N1 = tk.Label(self.content, text="Franz Benjamin Africano", bg="#F1F1F1", anchor="center",
                           font=("Arial", 11, "bold"))
        ...
        self.N2 = tk.Label(self.content, text="Matt Terrence Rias", bg="#F1F1F1", anchor="center",
                           font=("Arial", 11, "bold"))
        ...
        self.N4 = tk.Label(self.content, text="Beau Lawyjet Sison", bg="#F1F1F1", anchor="center",
                           font=("Arial", 11, "bold"))
...
Through this research, Team Terra aspires to bridge the gap between computer science and environmental sustainability, contributing to a smarter, data-informed approach to preserving Laguna Lake’s ecological balance."""
        ...
        self.project_label = tk.Label(self.content, text=self.project_info, wraplength=1000, justify="center",
                                      bg="#F1F1F1", font=("Arial", 12))
